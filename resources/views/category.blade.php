...
<div x-data="{ openProfile: false }" class="relative ml-auto">
    ...
    <div class="flex justify-center gap-5 mt-10 mb-5">
        <div class="w-1/2 bg-white rounded-full w-[1000px] px-8 py-1 flex items-center gap-3 shadow">
        <img src="{{ asset('search.svg') }}" class="w-5 h-5 opacity-70" alt="">
        <input
        type="text"
    ...
    <img class="w-10 h-10" src="{{ asset('filter.svg') }}" alt=""> 
    </div>
    <div class="flex justify-center gap-10 mb-10">
        <button class="relative bg-white hover:bg-customHover hover:text-white text-blacktext font-semibold py-2 px-4 rounded-full flex items-center gap-2 shadow-md">
        Girlgroup
    </button>
    <button class="relative bg-white hover:bg-customHover hover:text-white text-blacktext font-semibold py-2 px-4 rounded-full flex items-center gap-2 shadow-md">
        Boygroup
