    ...
    <div class="min-h-screen flex bg-secondary">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="flex p-4 gap-3">
                <button class="bg-white text-[#5A6ACF] font-semibold px-4 py-2 rounded-lg hover:bg-gray-300 transition">Save Changes</button>
                <a href="{{ route('admin.accountmanage') }}" class="bg-white text-[#5A6ACF] font-semibold px-4 py-2 rounded-lg hover:bg-gray-300 transition">Cancel</a>
            </div>
            </main>
