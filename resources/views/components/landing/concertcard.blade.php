...
<div class="relative flex gap-10 justify-center mt-10 mb-10">
    <div class="relative top-10 left-[30px] w-[500.691px] h-[330.781px] text-center bg-white rounded-[20px] p-8 transition-all duration-300 
            hover:scale-110">
        <p>CATEGORY</p>
        <h1 class="text-3xl font-bold mt-4 mb-4">Concert Name 1</h1>
        <p class="mb-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odit quis fugiat distinctio, itaque, atque iusto voluptatum numquam accusamus neque, dicta excepturi aut perferendis amet suscipit! Ea, alias libero. Minima, inventore?</p>
        {{ $slot }}
